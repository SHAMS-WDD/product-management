    ...
    <div class="fixed inset-0 z-50 items-center justify-center overflow-auto bg-gray-800 bg-opacity-50 animated zoomIn"
        ...
        <div class="flex items-center justify-center w-full min-h-screen"> 
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md mx-auto"> 
                ...
                <div class="p-4"> 
                    <form id="save-form" action="/products" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="space-y-4">
                            <div>
                            ...
                            <div>
                                <br />
                                <img class="w-14 rounded-sm" id="newImg" src="{{ asset('images/default.jpg') }}" />
                                <br />
                        ...
                        <button type="submit" id="save-btn"
                            class="px-4 py-2 bg-green-600 text-white rounded-md shadow hover:bg-green-700 focus:outline-none">Save</button>
                    </form>
                </div>
                <div class="border-t px-4 py-2 flex justify-end space-x-2"> 
                    <a href="/products" id="modal-close"
